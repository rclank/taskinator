...
var taskFormHandler = function(event) {
    ...
    // has data attribute, so get task id and call to complete edit process
    if (isEdit) {
...
var taskButtonHandler = function(event) {
    ...
    // delete button was clicked
        ...
        // why am i able to call deleteTask even if I move the fxn expression
        // after this line?
        deleteTask(taskIdCounter);
    }
};
...
var loadTasks = function() {
    ...
    //     let currentTaskObj = tasks[i];
    //     let currentTaskEl = createTaskEl(currentTaskObj);
    //     switch (currentTaskObj.status) {
    //         case 'to do':
    //             tasksToDoEl.appendChild(currentTaskEl);
    //             break;
    //         case 'in progress':
    //             tasksInProgressEl.appendChild(currentTaskEl);
    //             break;
    //         case 'completed':
    //             tasksCompletedEl.appendChild(currentTaskEl);
    //             break;
    //     }
    }
}
